...
namespace vcsparser.core
{
    public class MeasureConverterListBuilder
    {
        ...
        private void CreateMeasureConvertersForPeriod(List<IMeasureConverter> result, DateTime startDate, DateTime endDate, string metricKeySuffix, string suffixLongDescription, SonarGenericMetricsCommandLineArgs a)
        {
            ...
            var metricChangesBugDatabse = CreateMetric(BUG_DATABASE_CHANGES_METRIC_KEY + metricKeySuffix,
              "Number of changes in bug fixes (" + suffixLongDescription + ")", "Number of changes in bug fixes (" + suffixLongDescription + ")");
            var metricChangesWithFixesBugDatabse = CreateMetric(BUG_DATABASE_LINES_CHANGED_METRIC_KEY + metricKeySuffix,
            ...
            result.Add(new MeasureConverter<int>(startDate, endDate, metricChangesBugDatabse, new NumberOfChangesBugDatabaseMeasureAggregator(), a.FilePrefixToRemove));
            result.Add(new MeasureConverter<int>(startDate, endDate, metricChangesWithFixesBugDatabse, new LinesChangedBugDatabaseMeasureAggregator(), a.FilePrefixToRemove));
        }
